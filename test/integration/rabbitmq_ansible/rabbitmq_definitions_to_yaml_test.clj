(ns integration.rabbitmq-ansible.rabbitmq-definitions-to-yaml-test
  (:require [clojure.test :refer :all]
            [integration.rabbitmq-ansible.rabbitmq-definitions-to-yaml
             :as rabbit_yaml :refer :all]))
...
(def actual_rabbitmq_definitions_ansible_yaml
    (rabbit_yaml/generate_ansible_yaml rabbitmq_definitions_json))
...
(def actual_canary_testing_yaml
  (rabbit_yaml/generate_single_vhost_params_yaml
